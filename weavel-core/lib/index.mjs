...
})(WeavelPersistedProperty || (WeavelPersistedProperty = {}));
...
class WeavelCoreStateless {
  ...
  enqueue(type, body) {
    try {
      ...
      const queue = this.getPersistedProperty(WeavelPersistedProperty.Queue) || [];
      queue.push({
        type,
        ...body
      });
      this.setPersistedProperty(WeavelPersistedProperty.Queue, queue);
...
export { WeavelCore, WeavelGenerationClient, WeavelMemoryStorage, WeavelObjectClient, WeavelPersistedProperty, WeavelSessionClient, WeavelSpanClient, WeavelTraceClient, WeavelWebSessionClient, WeavelWebStateless, utils };
