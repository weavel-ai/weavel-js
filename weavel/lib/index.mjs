import { WeavelCore, utils, WeavelWebStateless } from 'weavel-core';
...
class Weavel extends WeavelCore {
  constructor(params) {
...
class WeavelWeb extends WeavelWebStateless {
  constructor(params) {
    const weavelConfig = utils.configWeavelSDK(params);
    super(weavelConfig);
...
export { Weavel, WeavelWeb, Weavel as default };
